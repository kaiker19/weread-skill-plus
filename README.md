...
把你在微信读书的划线和笔记，变成能用起来的东西——能搜、能连、写作时自动回来找你。本地运行，数据不上传。

- **召回**：写东西时打一句话，散落在十几本书里的相关划线自动找回来。
- **跨书呼应**：今天读的，自动和几个月前另一本书里的批注连起来。
- **每日回顾 / 读后总结**：不用你打开，每天告诉你今天读了什么、想了什么；读完一本书帮你收尾。
- **概念地图**：读过的书连成一张能点开的概念网。

两种用法：下载**双击版**（图形界面），或装成 **Claude Code / OpenClaw 技能**（每天主动推送）。
...
https://github.com/user-attachments/assets/867c0e8d-0b88-4318-b417-e32d2fd683aa
