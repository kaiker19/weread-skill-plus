...
在微信读书官方 [weread-skills](https://weread.qq.com/r/weread-skills) 接口之上，叠加两项**主动洞察能力**，并维护一个本地 SQLite 知识库做增量沉淀。官方 skill 负责"你问我答"，这个扩展负责"不问也说"——每天主动告诉你今天读了什么、想了什么，读完一本书帮你收尾，并把今天的划线和几个月前另一本书里的批注连起来。
